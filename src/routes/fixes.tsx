...
import { FixStreams, PageClose, PageHero, ReadingSections } from "@/components/wrath/inner-pages";
import { inner, meta } from "@/content/inner-pages";
import { pageMeta } from "@/lib/page-meta";
export const Route=createFileRoute("/fixes")({staticData:{sitemap:true},head:()=>pageMeta(...meta.fixes),component:FixesPage});
