  ...
  return <section className="home-band hero-band">
    <div className="site-grid hero-grid">
      ...
      <div className="col-span-7 hero-visual" role="img" aria-label={diagramLabels.hero}>
        ...
        <svg className="hero-feature-connectors" viewBox="0 0 720 550" aria-hidden="true" focusable="false"><path d="M152 248 C 181 248, 172 211, 204 211"/><path d="M164 352 C 192 352, 177 330, 204 330"/><path d="M152 456 C 185 456, 172 474, 204 474"/>{[[152,248],[204,211],[164,352],[204,330],[152,456],[204,474]].map(([cx, cy]) => <circle key={`${cx}-${cy}`} cx={cx} cy={cy} r="3"/>)}</svg>
