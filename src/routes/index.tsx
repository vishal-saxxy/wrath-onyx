  ...
  return <section className="home-band consideration-band">
    ...
    <div className="pin-stage site-grid">
      <div className="col-span-5"><BandHeader eyebrow={b.consideration.eyebrow} headline={<Headline lines={b.consideration.headline}/>} lead={b.consideration.lead}/><TextLink label={b.consideration.link} to={b.consideration.linkHref}/></div>
       <div className="col-start-6 col-span-7 consideration-answer"><LayeredAnswer selected={selected}/><div className="pin-step label-mono" aria-hidden="true"><span className={selected === 1 ? "is-active" : ""}>{b.consideration.cards[0].name}</span><span className={selected === 2 ? "is-active" : ""}>{b.consideration.cards[1].name}</span><span className={selected === 3 ? "is-active" : ""}>{b.consideration.cards[2].name}</span></div></div>
