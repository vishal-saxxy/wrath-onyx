  ...
  return <section className="home-band hero-band">
    <div className="site-grid hero-grid">
      ...
      <div className="col-span-7 hero-visual" role="img" aria-label={diagramLabels.hero}>
        ...
        <div className="engine-annotation"><span>Multiple AI engines.<br/>One answer.</span><svg viewBox="0 0 132 64" aria-hidden="true" focusable="false"><path d="M126 5C116 28 79 42 12 53m15 6L9 54l13-13"/></svg></div>
        ...
        <div className="hero-annotation"><svg viewBox="0 0 270 112" aria-hidden="true" focusable="false"><path d="M262 103C211 102 130 88 10 16m15-2L8 14l7 13"/></svg><span className="annotation">{illustrative.heroAnnotation}</span></div>
