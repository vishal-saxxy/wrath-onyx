...
export const inner = {
  ...
  work: { eyebrow: "OUR WORK", headline: ["What actually", "gets handed over."], lead: "Engagements are described by what was produced and who owns each remaining step. Standing honesty line directly beneath at body contrast: These pages describe work delivered and prepared. They do not claim measured change in AI answers, search traffic or revenue.", honesty: "These pages describe work delivered and prepared. They do not claim measured change in AI answers, search traffic or revenue." },
  case: {
